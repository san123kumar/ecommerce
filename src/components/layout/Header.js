            ...
            <nav className="navbar navbar-top-bg">
                <div className="container-md">
                    <Link href="/" className='navbar-brand'>
                        <Image src = "/images/logo.jpg" width={85} height={50} alt="logo"/>
                    </Link>
            ...
            <nav class="navbar navbar-expand-lg shadow-sm mb-2 rounded container px-2">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <div class="navbar-nav"> 
                        <Link href="/" className="nav-item nav-link active"><b>Store</b></Link>
                        <Link href="/about" className="nav-item nav-link active"><b>About Us</b></Link>
                    </div>
                </div>            
            </nav>
